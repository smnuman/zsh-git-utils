...
Generate standard `.gitignore` file for any git repository with sensible defaults.

**Features:**
- Prompts before overwriting existing files
- Includes patterns for OS files, editors, logs, dependencies, temp files, and secrets
- Creates custom section for project-specific patterns
...
Generate `.gsubignore` file to specify which folders should NOT be converted to submodules.
...
gsub-all "Initial commit"  # Will respect .gsubignore
```
